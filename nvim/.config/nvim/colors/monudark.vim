...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  let g:terminal_ansi_colors = ['#43454b', '#8599b7', '#549F9C', '#d9c668',
        ...
        \ '#b1faeb', '#dcea8f', '#6bdfff', '#9fafaf', '#dfaf52', '#ffffff']
  if has('nvim')
    ...
    let g:terminal_color_11 = '#dcea8f'
    let g:terminal_color_12 = '#6bdfff'
    let g:terminal_color_13 = '#9fafaf'
    let g:terminal_color_14 = '#dfaf52'
    let g:terminal_color_15 = '#ffffff'
  endif
  if !exists('g:monudark_green_comments')
    let g:monudark_green_comments = 0
  endif
  if !exists('g:monudark_emph_types')
    let g:monudark_emph_types = 1
  endif
  if !exists('g:monudark_emph_funcs')
    let g:monudark_emph_funcs = 0
  endif
  if !exists('g:monudark_emph_idents')
    let g:monudark_emph_idents = 0
  endif
  if !exists('g:monudark_match_paren_style')
    let g:monudark_match_paren_style = 0
  endif
  if !exists('g:monudark_dim_punctuation')
    let g:monudark_dim_punctuation = 1
  endif
  hi Normal guifg=#ffffff guibg=#161616 gui=NONE cterm=NONE
  hi Cursor guifg=#161616 guibg=#ffffff gui=NONE cterm=NONE
  hi None guifg=#ffffff guibg=NONE gui=NONE cterm=NONE
  hi CursorLineNr guifg=#ffffff guibg=#26262b gui=NONE cterm=NONE
  hi EndOfBuffer guifg=#161616 guibg=#161616 gui=NONE cterm=NONE
  ...
  hi MatchWord guifg=#ffffff guibg=#cb712a gui=NONE cterm=NONE
  ...
  hi Pmenu guifg=#ffffff guibg=#161616 gui=NONE cterm=NONE
  hi PmenuSbar guifg=#34353b guibg=#161616 gui=NONE cterm=NONE
  hi PmenuSel guifg=#ffffff guibg=#262626 gui=NONE cterm=NONE
  ...
  hi WarningMsg guifg=#dcea8f guibg=NONE gui=NONE cterm=NONE
  ...
  hi QuickFixLine guifg=#ffffff guibg=#cb712a gui=NONE cterm=NONE
  hi StatusLine guifg=#ffffff guibg=#43454b gui=NONE cterm=NONE
  hi StatusLineNC guifg=#767b6f guibg=#34353b gui=NONE cterm=NONE
  hi VertSplit guifg=#34353b guibg=#34353b gui=NONE cterm=NONE
  hi WildMenu guifg=#ffffff guibg=#cb712a gui=NONE cterm=NONE
  hi IncSearch guifg=#161616 guibg=#fef937 gui=NONE cterm=NONE
  ...
  hi DiffChange guifg=#dcea8f guibg=NONE gui=NONE cterm=NONE
  hi DiffDelete guifg=#8599b7 guibg=#2f2625 gui=NONE cterm=NONE
  hi DiffText guifg=#dcea8f guibg=#2e2622 gui=NONE cterm=NONE
  hi Comment guifg=#767b6f guibg=NONE gui=NONE cterm=NONE
  hi Error guifg=#161616 guibg=#8599b7 gui=NONE cterm=NONE
  hi PreProc guifg=#dcea8f guibg=NONE gui=NONE cterm=NONE
  ...
  let g:limelight_conceal_guifg = '#767b6f'
  ...
  hi markdownDelimiter guifg=#549F9C guibg=NONE gui=NONE cterm=NONE
  hi markdownCode guifg=#dfaf52 guibg=#34353b gui=NONE cterm=NONE
  if g:monudark_green_comments
  ...
  if g:monudark_emph_types
    hi Typedef guifg=#6bdfff guibg=NONE gui=NONE cterm=NONE
    hi LocalType guifg=#b1faeb guibg=NONE gui=NONE cterm=NONE
    hi LibraryType guifg=#dfaf52 guibg=NONE gui=NONE cterm=NONE
  else
    hi Typedef guifg=#4ec4e6 guibg=NONE gui=NONE cterm=NONE
    hi LocalType guifg=#549F9C guibg=NONE gui=NONE cterm=NONE
    hi LibraryType guifg=#86a3a4 guibg=NONE gui=NONE cterm=NONE
  endif
  if g:monudark_emph_funcs
    hi FunctionDef guifg=#6bdfff guibg=NONE gui=NONE cterm=NONE
    hi LocalFunc guifg=#b1faeb guibg=NONE gui=NONE cterm=NONE
    hi LibraryFunc guifg=#dfaf52 guibg=NONE gui=NONE cterm=NONE
  else
    hi FunctionDef guifg=#4ec4e6 guibg=NONE gui=NONE cterm=NONE
    hi LocalFunc guifg=#549F9C guibg=NONE gui=NONE cterm=NONE
    hi LibraryFunc guifg=#86a3a4 guibg=NONE gui=NONE cterm=NONE
  endif
  if g:monudark_emph_idents
    hi IdentifierDef guifg=#6bdfff guibg=NONE gui=NONE cterm=NONE
    hi LocalIdent guifg=#b1faeb guibg=NONE gui=NONE cterm=NONE
    hi LibraryIdent guifg=#dfaf52 guibg=NONE gui=NONE cterm=NONE
  else
    hi IdentifierDef guifg=#4ec4e6 guibg=NONE gui=NONE cterm=NONE
    hi LocalIdent guifg=#549F9C guibg=NONE gui=NONE cterm=NONE
    hi LibraryIdent guifg=#86a3a4 guibg=NONE gui=NONE cterm=NONE
  endif
  if g:monudark_match_paren_style
    hi MatchParen guifg=#161616 guibg=#fef937 gui=NONE cterm=NONE
  else
    hi MatchParen guifg=#ffffff guibg=#cb712a gui=NONE cterm=NONE
  endif
  if g:monudark_dim_punctuation
